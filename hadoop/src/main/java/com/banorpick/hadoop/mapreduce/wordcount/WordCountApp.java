 ...
 * Class Name: com.banorpick.hadoop.mapreduce.wordcount.WordCountApp
...
//        }
        ...
        Path outputPath = new Path("/wordcount/output/WordCountApp");
        if (fileSystem.exists(outputPath)) {
            fileSystem.delete(outputPath, true);
        }

        // 设置作业输入文件和输出文件的路径
        FileInputFormat.setInputPaths(job, new Path("/wordcount/input.txt"));
